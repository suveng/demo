...
public class DataSourceConfig {
    ...
    public DataSource master() {
        ...
        druidDataSource
                .setUrl("jdbc:mysql://192.168.9.234:3306/oauth2?useUnicode=true&characterEncoding=utf-8&useSSL=false");
    ...
    @Primary
    public DynamicDataSource dataSource(@Qualifier(value = "dataSource") DataSource masterDataSource) {
