...
public final class PayServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.qw.grpc.api.pay.PayRequest,
      com.qw.grpc.api.pay.PayResponse> getGetRealNameByUsernameMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getRealNameByUsername",
      requestType = com.qw.grpc.api.pay.PayRequest.class,
      responseType = com.qw.grpc.api.pay.PayResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.qw.grpc.api.pay.PayRequest,
      com.qw.grpc.api.pay.PayResponse> getGetRealNameByUsernameMethod() {
    io.grpc.MethodDescriptor<com.qw.grpc.api.pay.PayRequest, com.qw.grpc.api.pay.PayResponse> getGetRealNameByUsernameMethod;
      ...
      synchronized (PayServiceGrpc.class) {
        if ((getGetRealNameByUsernameMethod = PayServiceGrpc.getGetRealNameByUsernameMethod) == null) {
          PayServiceGrpc.getGetRealNameByUsernameMethod = getGetRealNameByUsernameMethod =
              io.grpc.MethodDescriptor.<com.qw.grpc.api.pay.PayRequest, com.qw.grpc.api.pay.PayResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getRealNameByUsername"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.qw.grpc.api.pay.PayRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.qw.grpc.api.pay.PayResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.qw.grpc.api.pay.PayRequest,
      com.qw.grpc.api.pay.PayResponse> getGetRealNameByUsernameResStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<com.qw.grpc.api.pay.PayRequest,
      com.qw.grpc.api.pay.PayResponse> getGetRealNameByUsernameResStreamMethod() {
    io.grpc.MethodDescriptor<com.qw.grpc.api.pay.PayRequest, com.qw.grpc.api.pay.PayResponse> getGetRealNameByUsernameResStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.qw.grpc.api.pay.PayRequest,
      com.qw.grpc.api.pay.PayResponse> getGetRealNameByUsernameReqStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<com.qw.grpc.api.pay.PayRequest,
      com.qw.grpc.api.pay.PayResponse> getGetRealNameByUsernameReqStreamMethod() {
    io.grpc.MethodDescriptor<com.qw.grpc.api.pay.PayRequest, com.qw.grpc.api.pay.PayResponse> getGetRealNameByUsernameReqStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.qw.grpc.api.pay.PayRequest,
      com.qw.grpc.api.pay.PayResponse> getGetRealNameByUsernameStreamAllMethod;
  ...
  public static io.grpc.MethodDescriptor<com.qw.grpc.api.pay.PayRequest,
      com.qw.grpc.api.pay.PayResponse> getGetRealNameByUsernameStreamAllMethod() {
    io.grpc.MethodDescriptor<com.qw.grpc.api.pay.PayRequest, com.qw.grpc.api.pay.PayResponse> getGetRealNameByUsernameStreamAllMethod;
  ...
  public static abstract class PayServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getRealNameByUsername(com.qw.grpc.api.pay.PayRequest request,
        io.grpc.stub.StreamObserver<com.qw.grpc.api.pay.PayResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getRealNameByUsernameResStream(com.qw.grpc.api.pay.PayRequest request,
        io.grpc.stub.StreamObserver<com.qw.grpc.api.pay.PayResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.qw.grpc.api.pay.PayRequest> getRealNameByUsernameReqStream(
        io.grpc.stub.StreamObserver<com.qw.grpc.api.pay.PayResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.qw.grpc.api.pay.PayRequest> getRealNameByUsernameStreamAll(
        io.grpc.stub.StreamObserver<com.qw.grpc.api.pay.PayResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.qw.grpc.api.pay.PayRequest,
                com.qw.grpc.api.pay.PayResponse>(
  ...
  public static final class PayServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<PayServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.qw.grpc.api.pay.PayResponse getRealNameByUsername(com.qw.grpc.api.pay.PayRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.qw.grpc.api.pay.PayResponse> getRealNameByUsernameResStream(
        com.qw.grpc.api.pay.PayRequest request) {
  ...
  public static final class PayServiceFutureStub extends io.grpc.stub.AbstractFutureStub<PayServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.qw.grpc.api.pay.PayResponse> getRealNameByUsername(
        com.qw.grpc.api.pay.PayRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_REAL_NAME_BY_USERNAME:
          serviceImpl.getRealNameByUsername((com.qw.grpc.api.pay.PayRequest) request,
              (io.grpc.stub.StreamObserver<com.qw.grpc.api.pay.PayResponse>) responseObserver);
          break;
        case METHODID_GET_REAL_NAME_BY_USERNAME_RES_STREAM:
          serviceImpl.getRealNameByUsernameResStream((com.qw.grpc.api.pay.PayRequest) request,
              (io.grpc.stub.StreamObserver<com.qw.grpc.api.pay.PayResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class PayServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.qw.grpc.api.pay.Pay.getDescriptor();
    }
