...
public final class OrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.qw.grpc.api.order.OrderRequest,
      com.qw.grpc.api.order.OrderResponse> getGetRealNameByUsernameMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getRealNameByUsername",
      requestType = com.qw.grpc.api.order.OrderRequest.class,
      responseType = com.qw.grpc.api.order.OrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.qw.grpc.api.order.OrderRequest,
      com.qw.grpc.api.order.OrderResponse> getGetRealNameByUsernameMethod() {
    io.grpc.MethodDescriptor<com.qw.grpc.api.order.OrderRequest, com.qw.grpc.api.order.OrderResponse> getGetRealNameByUsernameMethod;
      ...
      synchronized (OrderServiceGrpc.class) {
        if ((getGetRealNameByUsernameMethod = OrderServiceGrpc.getGetRealNameByUsernameMethod) == null) {
          OrderServiceGrpc.getGetRealNameByUsernameMethod = getGetRealNameByUsernameMethod =
              io.grpc.MethodDescriptor.<com.qw.grpc.api.order.OrderRequest, com.qw.grpc.api.order.OrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getRealNameByUsername"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.qw.grpc.api.order.OrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.qw.grpc.api.order.OrderResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.qw.grpc.api.order.OrderRequest,
      com.qw.grpc.api.order.OrderResponse> getGetRealNameByUsernameResStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<com.qw.grpc.api.order.OrderRequest,
      com.qw.grpc.api.order.OrderResponse> getGetRealNameByUsernameResStreamMethod() {
    io.grpc.MethodDescriptor<com.qw.grpc.api.order.OrderRequest, com.qw.grpc.api.order.OrderResponse> getGetRealNameByUsernameResStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.qw.grpc.api.order.OrderRequest,
      com.qw.grpc.api.order.OrderResponse> getGetRealNameByUsernameReqStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<com.qw.grpc.api.order.OrderRequest,
      com.qw.grpc.api.order.OrderResponse> getGetRealNameByUsernameReqStreamMethod() {
    io.grpc.MethodDescriptor<com.qw.grpc.api.order.OrderRequest, com.qw.grpc.api.order.OrderResponse> getGetRealNameByUsernameReqStreamMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.qw.grpc.api.order.OrderRequest,
      com.qw.grpc.api.order.OrderResponse> getGetRealNameByUsernameStreamAllMethod;
  ...
  public static io.grpc.MethodDescriptor<com.qw.grpc.api.order.OrderRequest,
      com.qw.grpc.api.order.OrderResponse> getGetRealNameByUsernameStreamAllMethod() {
    io.grpc.MethodDescriptor<com.qw.grpc.api.order.OrderRequest, com.qw.grpc.api.order.OrderResponse> getGetRealNameByUsernameStreamAllMethod;
  ...
  public static abstract class OrderServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getRealNameByUsername(com.qw.grpc.api.order.OrderRequest request,
        io.grpc.stub.StreamObserver<com.qw.grpc.api.order.OrderResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getRealNameByUsernameResStream(com.qw.grpc.api.order.OrderRequest request,
        io.grpc.stub.StreamObserver<com.qw.grpc.api.order.OrderResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.qw.grpc.api.order.OrderRequest> getRealNameByUsernameReqStream(
        io.grpc.stub.StreamObserver<com.qw.grpc.api.order.OrderResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.qw.grpc.api.order.OrderRequest> getRealNameByUsernameStreamAll(
        io.grpc.stub.StreamObserver<com.qw.grpc.api.order.OrderResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.qw.grpc.api.order.OrderRequest,
                com.qw.grpc.api.order.OrderResponse>(
  ...
  public static final class OrderServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<OrderServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.qw.grpc.api.order.OrderResponse getRealNameByUsername(com.qw.grpc.api.order.OrderRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.qw.grpc.api.order.OrderResponse> getRealNameByUsernameResStream(
        com.qw.grpc.api.order.OrderRequest request) {
  ...
  public static final class OrderServiceFutureStub extends io.grpc.stub.AbstractFutureStub<OrderServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.qw.grpc.api.order.OrderResponse> getRealNameByUsername(
        com.qw.grpc.api.order.OrderRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_REAL_NAME_BY_USERNAME:
          serviceImpl.getRealNameByUsername((com.qw.grpc.api.order.OrderRequest) request,
              (io.grpc.stub.StreamObserver<com.qw.grpc.api.order.OrderResponse>) responseObserver);
          break;
        case METHODID_GET_REAL_NAME_BY_USERNAME_RES_STREAM:
          serviceImpl.getRealNameByUsernameResStream((com.qw.grpc.api.order.OrderRequest) request,
              (io.grpc.stub.StreamObserver<com.qw.grpc.api.order.OrderResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class OrderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.qw.grpc.api.order.Order.getDescriptor();
    }
