...
public class MySocketClientHandler extends SimpleChannelInboundHandler<MessageProto.Message> {
	...
	public void channelActive(ChannelHandlerContext ctx) throws Exception {
		...
		MessageProto.Message message = MessageProto.Message.newBuilder().setType(MessageProto.Message.Type.CatType).setCat(MessageProto.Cat.newBuilder().setName("123")).build();
