...
package my.suveng.dubbodemo.dubbo.demo.provider;
...
import my.suveng.dubbodemo.dubbo.demo.api.RestService;
import my.suveng.dubbodemo.dubbo.demo.api.User;

import static my.suveng.dubbodemo.dubbo.util.LoggerUtils.log;
...
@RestController
public class SpringRestServiceImpl implements RestService {
