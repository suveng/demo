...
public class EsService {
    ...
    public void updateSuggest(StudentTemplate studentTemplate) {
        AnalyzeRequest analyzeRequest = new AnalyzeRequest().index(INDEX_NAME).text(studentTemplate.getName())
                .analyzer("ik_smart");
    ...
    public String analyze(String text) {
        AnalyzeRequest analyzeRequest = new AnalyzeRequest().text(text).analyzer("ik_smart");
