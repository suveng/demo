...
public class FemaleRepositoryTest extends BaseTest {
    ...
    /**
     * description: 添加测试数据 author: suwenguang date: 2019-09-01
     */
    @Test
    ...
    /**
     * description: 测试查询构造器 author: suwenguang date: 2019-09-01
     */
    ...
    /**
     * description: 测试范围查询 author: suwenguang date: 2019-09-01
     */
    @Test
    ...
    public void findByCreateTimeBetween() {
        ...
        Page<Female> byCreateTimeBetween = femaleRepository.findByCreateTimeBetween(localDate.minusDays(2).toDate(),
                localDate.toDate(), PageRequest.of(0, 10));
        System.out.println(JSON.toJSONString(byCreateTimeBetween.getContent()));
    }

    /**
     * description: 多条件 author: suwenguang date: 2019-09-01
     */
    @Test
    public void querydsl() {
        PageRequest of = PageRequest.of(0, 10);
        QFemale female = QFemale.female;
        BooleanExpression createTimeBetween = female.createTime.between(LocalDate.now().minusDays(2).toDate(),
